...
export function QuoteSnapshot({ quote, onOpenPreview }: QuoteSnapshotProps) {
  ...
  return (
    <div className="space-y-4">
      ...
      >
        {/* 📄 THE MINIATURE DOCUMENT (Live-like representation) */}
        <div className="absolute inset-4 bg-white shadow-2xl rounded-2xl overflow-hidden transition-all duration-700 group-hover:scale-[1.03] group-hover:-rotate-1">
          ...
          <div className="p-4 flex flex-col h-full pointer-events-none select-none">
            {/* Header */}
            <div className="flex justify-between items-start mb-3">
              <div className="flex items-center gap-1">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-[3px] font-bold text-slate-300 uppercase tracking-tighter leading-none">Professional Systems</span>
                </div>
              </div>
              <div className="text-right">
                <div className="w-8 h-1 bg-slate-900/10 rounded-full mb-0.5" />
                <div className="w-6 h-0.5 bg-slate-300/20 rounded-full ml-auto" />
              </div>
            </div>

            {/* Title Area */}
            <div className="mb-4 border-b border-primary/10 pb-2">
               <div className="w-16 h-2 bg-primary/5 rounded mb-1" />
            ...
            <div className="grid grid-cols-2 gap-3 mb-4">
               <div className="p-2 bg-slate-50/50 rounded-xl border border-slate-100/50">
                  <div className="w-full h-1.5 bg-slate-900/5 rounded-full mb-1" />
                  <div className="w-2/3 h-0.5 bg-slate-200 rounded-full" />
               </div>
               <div className="space-y-1 flex flex-col justify-center">
                  <div className="flex justify-between items-center"><div className="w-4 h-0.5 bg-slate-200 rounded-full" /><div className="w-5 h-0.5 bg-slate-300 rounded-full" /></div>
                  <div className="flex justify-between items-center"><div className="w-4 h-0.5 bg-slate-200 rounded-full" /><div className="w-5 h-0.5 bg-slate-300 rounded-full" /></div>
               </div>
            </div>
            ...
            <div className="flex-1 space-y-1">
               <div className="w-full h-2 bg-primary/10 rounded-sm mb-1.5" />
               {[1, 2, 3, 4].map(i => (
                 <div key={i} className="flex justify-between items-center border-b border-slate-50 pb-1">
                    <div className="flex flex-col gap-0.5 flex-1">
                       ...
                       <div className="w-1/3 h-0.5 bg-slate-100 rounded-full" />
                    </div>
                    <div className="w-4 h-1 bg-slate-900/5 rounded-full" />
                 </div>
               ))}
            </div>
            ...
            <div className="mt-4 flex flex-col items-end gap-2">
               <div className="w-12 h-3 bg-primary/5 rounded" />
               <div className="flex gap-2 w-full mt-2">
                  <div className="flex-1 h-6 bg-slate-50 rounded-lg flex items-center justify-center border border-slate-100"><Check size={8} className="text-primary/20" /></div>
                  <div className="flex-1 h-6 bg-slate-50 rounded-lg flex items-center justify-center border border-slate-100"><PenLine size={8} className="text-slate-100" /></div>
               </div>
            </div>
          </div>
        </div>

        {/* 👁️ HOVER INTERACTION: THE "WOW" EFFECT */}
        <div className="absolute inset-0 bg-primary/0 group-hover:bg-primary/5 backdrop-blur-[0px] group-hover:backdrop-blur-[3px] transition-all duration-700 flex flex-col items-center justify-center gap-4">
          ...
          <div className="flex flex-col items-center gap-1 opacity-0 group-hover:opacity-100 translate-y-8 group-hover:translate-y-0 transition-all duration-700 delay-100">
             <span className="text-[12px] font-black uppercase tracking-[0.4em] text-primary">VOIR PLEIN ÉCRAN</span>
             <span className="text-[8px] font-bold text-primary/40 uppercase tracking-widest">Document Haute Qualité</span>
          </div>
        </div>

        {/* 🟢 PULSING INDICATOR */}
        <div className={cn(
           "absolute top-10 right-10 w-2 h-2 rounded-full",
           quote.status === 'accepted' ? 'bg-emerald-500 shadow-[0_0_15px_rgba(16,185,129,0.8)]' : 'bg-orange-500 shadow-[0_0_15px_rgba(249,115,22,0.8)]',
           "animate-pulse"
        )} />
      </Card>
      ...
      <div className="grid grid-cols-2 gap-4">
         ...
         <div className="p-5 bg-white rounded-[2rem] border border-slate-100 shadow-sm flex flex-col gap-1 transition-all hover:shadow-xl hover:-translate-y-1">
            <span className="text-[10px] font-black text-slate-300 uppercase tracking-widest">Expiration</span>
